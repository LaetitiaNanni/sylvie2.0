...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-xs-10 column" id="content">
              ...
              <?php 
                ...
                while($rents = mysql_fetch_object($rent)) {
                  echo "<tr>";
                    ...
                    $nameState = getNameState($rents-> ID_State);
                    echo "<td>".$nameState-> name_state."</td>";
                    echo '<td><a href="?action=m&id='.($rents-> ID_Loan).'"><span class="fui-new"></span></a></td>';
                    echo '<td><a href="?action=s&id='.($rents-> ID_Loan).'"><span class="fui-cross"></span></a></td>';
                  echo "</tr>";
                }
              ?>
          </tbody>
      ...
      <a href="emprunt.php" class="button">Ajouter un emprunt</a>
    </div>
    <div class="clear"></div>
    <footer>
